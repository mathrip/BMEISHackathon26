...
- **9:00 AM - 9:30 AM**: Registration, Welcome & Project Idea Brainstorming (Last chance to submit project ideas!)
- **9:30 AM - 10:00 AM**: Opening Remarks & Project Pitches
- **10:00 AM - 10:45 AM**: Team Formation & Project Planning
...
- **3:15 PM - 5:00 PM**: Hacking Continues

### Day 2 - Thursday, June 25th
- **9:00 AM - 10:45 AM**: Hacking Continues
- **10:45 AM - 11:00 AM**: Morning Coffee Break
- **11:00 AM - 12:30 PM**: Hacking Continues
- **12:30 PM - 1:30 PM**: Lunch
- **1:30 PM - 3:00 PM**: Hacking Continues
- **3:00 PM - 3:15 PM**: Afternoon Coffee Break & Mid-Hackathon Check-in
- **3:15 PM - 5:00 PM**: Hacking Continues
- **Evening**: Hackathon Social

### Day 3 - Friday, June 26th
- **9:00 AM - 10:45 AM**: Final Hacking
- **10:45 AM - 11:00 AM**: Morning Coffee Break
- **11:00 AM - 12:30 PM**: Project Wrap Ups
- **12:30 PM - 1:30 PM**: Lunch
- **1:30 PM - 4:00 PM**: Project Presentations
- **4:00 PM - 5:00 PM**: Wrap-up & Closing Remarks

## Project Submission

All teams must submit their project using the [Project Proposal Template](projects/TEMPLATE.md).

Submit your proposal by:
1. Creating a new file in the `projects/` folder
2. Name it after your project (e.g., `projects/my-project-name.md`)
3. Use the template as a guide
